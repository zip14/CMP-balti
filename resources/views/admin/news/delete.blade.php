<div style="width:300px">
    ...
    <div class="col-md-12">
        ...
        <form method="POST" class="form-horizontal" id="news">
            {!! csrf_field() !!}
            <?php if(!empty($id)){?>
            ...
            <div class="panel-heading ui-draggable-handle">
                <h3 class="panel-title"><strong>Șterge știri</strong></h3>
...
<script>
    ...
    $("#news").submit(function(e){
        ...
        $.post(url, $('#news').serialize(), null, 'json').done(function(response) {
